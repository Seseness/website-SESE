...
const PRODUCT_CATALOGUE = {
  'cleansing-foam':       { name: 'Foaming Cleanser',         price: 26,  img: 'project/assets/products-new/cleansing-foam-hp.png',       bg: '#E3EEF5', variant: '58270777049472' },
  'hydrating-toner':      { name: 'Hydrating Toner',          price: 24,  img: 'project/assets/products-new/hydrating-toner-hp.png',      bg: '#E6EFE9', variant: '58270797693312' },
  'vitamin-c-serum':      { name: 'Vitamin C Serum',          price: 34,  img: 'project/assets/products-new/vitamin-c-serum-hp.png',      bg: '#FCEAD0', variant: '58270831509888' },
  'peptide-serum':        { name: 'Peptide Firming Serum',    price: 34,  img: 'project/assets/products-new/peptide-serum-hp.png',        bg: '#FCEAD0', variant: '58270806049152' },
  'retinol-alt-serum':    { name: 'Retinol Alt. Serum',       price: 26,  img: 'project/assets/products-new/retinol-alt-serum-hp.png',    bg: '#F5EAE4', variant: '58270807392640' },
  'firming-day-cream':    { name: 'Firming Day Cream',        price: 36,  img: 'project/assets/products-new/firming-day-cream-hp.png',    bg: '#FCE8EB', variant: '58270793138560' },
  'ceramide-night-cream': { name: 'Ceramide Night Cream',     price: 38,  img: 'project/assets/products-new/ceramide-night-cream-hp.png', bg: '#EFDFC2', variant: '58270801527168' },
  'smoothing-eye-cream':  { name: 'Smoothing Eye Cream',      price: 30,  img: 'project/assets/products-new/smoothing-eye-cream-hp.png',  bg: '#C9D7C9', variant: '58245768839552' },
  'spf50-stick':          { name: 'SPF 50 Sunscreen Stick',   price: 28,  img: 'project/assets/products-new/spf50-stick-hp.png',          bg: '#E8D5B0', variant: '58270809096576' },
