...
(() => {
  ...
  const COPY = {
    ...
    nl: {
      live: true,
      title: 'Welkom in de SESE-community',
      text: 'Schrijf je in voor onze nieuwsbrief en ontvang 10% korting op je eerste bestelling.',
      extra: 'Eerlijke skincare-tips, nieuwe producten als eerste zien, en geen spam. Beloofd.',
      placeholder: 'jouw@email.com',
      cta: 'Ja, ik wil 10% korting',
      microcopy: 'Je ontvangt de kortingscode meteen per mail.',
      closeLink: 'Nu niet',
    },
    fr: {
      live: true,
      title: 'Bienvenue dans la communauté SESE',
      text: 'Inscris-toi à notre newsletter et reçois 10% de réduction sur ta première commande.',
      extra: 'Des conseils skincare honnêtes, nos nouveautés en avant-première, et zéro spam. Promis.',
      placeholder: 'ton@email.com',
      cta: 'Oui, je veux 10% de réduction',
      microcopy: 'Tu reçois ton code de réduction directement par e-mail.',
