export const PRODUCTS = {
  ...
  "cleansing-foam": {
    ...
    "ingredients": [
      {
        ...
        "bg": "#E6EFE9",
        "nm": "Aloe Barbadensis Leaf Juice",
        "ds": "Calme et apaise pendant le nettoyage.",
        "pct": "Base"
      },
      {
        "abbr": "CG",
        "bg": "#E3EEF5",
        "nm": "Coco-Glucoside",
        "ds": "Tensioactif doux d'origine végétale.",
        "pct": "—"
      },
      {
        "abbr": "GLA",
        "bg": "#FAF7C9",
        "nm": "Gluconolactone (PHA)",
        "ds": "Exfolie en douceur sans irriter.",
        "pct": "3%"
      },
      {
        "abbr": "PAN",
        "bg": "#E6EFE9",
        "nm": "Panthenol",
        "ds": "Attire l'humidité et soutient la barrière cutanée.",
        "pct": "1%"
      },
      {
        "abbr": "CAM",
        "bg": "#FCE8EB",
        "nm": "Chamomile Extract",
        "ds": "Anti-rougeurs botanique, apaise visiblement la peau.",
        "pct": "0.5%"
      }
    ],
    "ingTitle": "Un début propre, <em>une fin apaisante.</em>",
    "howTitle": "Vingt secondes. <em>Deux fois par jour.</em>",
    "howÉtapes": [
      {
    ...
    "benefitGrad": "linear-gradient(160deg,#C5DAEA,#A0C4D6)",
    "quote": "\"Je ne pensais pas qu'un nettoyant ferait une différence. Celui-ci a changé mes matins.\"",
    "benefitTitle": "Le départ le plus propre <em>pour une meilleure peau.</em>",
    "benefitBody": [
      "La plupart des problèmes de peau commencent au nettoyage. Décapez la barrière et le reste de votre routine se retourne contre elle-même. Faites mousser doucement, rincez complètement, et laissez le reste faire son travail.",
      "Sans sulfates, sans parabènes, pas de sensation de tiraillement après. Juste propre."
    ],
    "stats": [
      {
        "n": "98",
        "suf": "%",
        "l": "Ont trouvé la peau apaisée — non décapée"
      },
      {
        "n": "0",
        "suf": "",
        "l": "Sulfates, parabènes, parfum"
      },
      {
        "n": "12",
        "suf": "w",
        "l": "PAO — stable après ouverture"
      }
    ],
    ...
    "inci": "Aqua, Aloe Barbadensis Leaf Juice, Glycerin, Coco-Glucoside, Gluconolactone, Panthenol, Chamomilla Recutita Flower Extract, Sodium Cocoyl Glutamate, Xanthan Gum, Sodium Benzoate, Potassium Sorbate, Citric Acid.",
    "inciNote": "95,2% d'origine naturelle. 100% végan. Sans parfum, sulfates, ni parabènes.",
    "pairs": [
      "hydrating-toner",
      "peptide-serum",
      "firming-day-cream",
  ...
  "hydrating-toner": {
    ...
    "ingredients": [
      {
        ...
        "bg": "#FCE8EB",
        "nm": "Rose Water",
        "ds": "Base botanique — hydrate et apaise en douceur.",
        "pct": "Base"
      },
      {
        "abbr": "NIA",
        "bg": "#E3EEF5",
        "nm": "Niacinamide",
        "ds": "Illumine, resserre les pores, renforce la barrière.",
        "pct": "3%"
      },
      {
        "abbr": "HA",
        "bg": "#E6EFE9",
        "nm": "Sodium Hyaluronate",
        "ds": "Attire l'eau dans les couches supérieures de la peau.",
        "pct": "1%"
      },
      {
        "abbr": "CER",
        "bg": "#FAF7C9",
        "nm": "Ceramide NP",
        "ds": "Molécule lipidique qui retient l'humidité.",
        "pct": "0.2%"
      },
      {
        "abbr": "BET",
        "bg": "#E3EEF5",
        "nm": "Betaine",
        "ds": "Humectant doux dérivé de la betterave à sucre.",
        "pct": "2%"
      }
    ],
    ...
    "howÉtapes": [
      ...
      },
      {
        ...
        "p": "Les cotons absorbent le produit et tirent sur la peau. Les paumes le font pénétrer sans gaspillage."
      },
      {
        "h": "Passez directement au sérum",
        "p": "Appliquez votre sérum dans les 30 secondes. Une peau tonifiée et humide absorbe bien mieux les actifs."
      }
    ],
    "benefitGrad": "linear-gradient(160deg,#C9D7C9,#A3BFA3)",
    ...
    "stats": [
      {
        "n": "+42",
        "suf": "%",
        "l": "Meilleure absorption du sérum sur peau préparée"
      },
      {
        "n": "97",
        "suf": "%",
        "l": "Peau plus souple ressentie en une semaine"
      },
      {
        "n": "0",
        "suf": "",
    ...
    "faqs": [
      ...
      },
      {
        ...
        "a": "Oui. À 3%, elle illumine et soutient la fonction barrière sans le risque d'irritation qui peut survenir à doses plus élevées. Bien tolérée par la plupart des peaux sensibles."
      },
      {
    ...
    "inci": "Aqua, Rosa Damascena Flower Water, Glycerin, Niacinamide (3%), Propanediol, Sodium Hyaluronate, Ceramide NP, Betaine, Panthenol, Sodium Benzoate, Potassium Sorbate, Citric Acid.",
    "inciNote": "96,8% d'origine naturelle. 100% végan. Sans alcool, parfum, ni colorants.",
    "pairs": [
      "cleansing-foam",
      "vitamin-c-serum",
      "peptide-serum",
  ...
  "vitamin-c-serum": {
    ...
    "quickInfo": [
      [
        "Usage matinal uniquement",
        "S'associe au SPF 50"
      ],
      [
        "Tous types de peau",
        "Test cutané si peau réactive"
      ]
    ],
    "routineActive": 2,
    "ingredients": [
      {
        ...
        "bg": "#FCEAD0",
        "nm": "Ascorbic Acid",
        "ds": "Vitamine C pure — illumine et stimule le collagène.",
        "pct": "12%"
      },
      {
        "abbr": "FER",
        "bg": "#FAF7C9",
        "nm": "Ferulic Acid",
        "ds": "Stabilise la vitamine C et double son effet antioxydant.",
        "pct": "0.5%"
      },
      {
        "abbr": "VE",
        "bg": "#E6EFE9",
        "nm": "Tocopherol (Vitamin E)",
        "ds": "Synergie antioxydante — maintient la stabilité de la formule.",
        "pct": "1%"
      },
      {
        "abbr": "NIA",
        "bg": "#E3EEF5",
        "nm": "Niacinamide",
        "ds": "Illumine les pores, lisse la texture, apaise les rougeurs.",
        "pct": "3%"
      },
      {
        "abbr": "HA",
        "bg": "#E3EEF5",
        "nm": "Sodium Hyaluronate",
        "ds": "Hydratation qui transporte les actifs plus profondément.",
        "pct": "1%"
      }
    ],
    ...
    "howÉtapes": [
      ...
      },
      {
        ...
        "p": "Laissez le sérum s'absorber complètement avant d'appliquer la crème hydratante par-dessus."
      },
      {
        "h": "Le SPF n'est pas négociable",
        "p": "La vitamine C rend la peau temporairement plus photosensible. Terminez toujours la routine du matin par un SPF 50."
      }
    ],
    "benefitGrad": "linear-gradient(160deg,#F4C9A8,#E0A870)",
    "quote": "\"Ma peau a l'air d'avoir bien dormi maintenant. Ce n'est pas le cas, mais elle en a l'air.\"",
    "benefitTitle": "Un éclat qui se construit, <em>ne s'emprunte pas.</em>",
    "benefitBody": [
      "La vitamine C illumine en interrompant la production de mélanine — l'effet est cumulatif. Le premier jour, vous le sentez. À la quatrième semaine, vous le voyez. Au deuxième mois, il se maintient.",
      "La formule utilise un système de stabilisation à l'acide férulique qui garde l'acide ascorbique actif de la première à la dernière goutte."
    ],
    "stats": [
      {
        "n": "+31",
        "suf": "%",
        "l": "Regain d'éclat après 4 semaines"
      },
      {
        "n": "87",
        "suf": "%",
        "l": "Teint plus uniforme à 8 semaines"
      },
      {
        "n": "12",
        "suf": "%",
        "l": "Acide ascorbique stable"
      }
    ],
    ...
    "faqs": [
      ...
      },
      {
        ...
        "a": "Une teinte orange signifie que la vitamine C s'oxyde. La formule est alors moins efficace. Conservez en dessous de 20°C et à l'abri de la lumière directe pour prolonger sa fraîcheur. La plupart des flacons durent 3 mois après ouverture."
      },
      {
      ...
      },
      {
        ...
        "a": "La vitamine C est un antioxydant. Elle agit contre les dommages environnementaux de la journée. Elle rend aussi la peau temporairement plus photosensible, donc l'associer au SPF le matin est le plus logique."
      }
    ],
    "inci": "Aqua, Ascorbic Acid (12%), Glycerin, Propanediol, Niacinamide (3%), Ferulic Acid, Tocopherol, Sodium Hyaluronate, Panthenol, Xanthan Gum, Citric Acid, Sodium Benzoate, Potassium Sorbate.",
    "inciNote": "89,3% d'origine naturelle. 100% végan. Sans parfum, parabènes, ni sulfates.",
    "pairs": [
      "hydrating-toner",
      "peptide-serum",
      "firming-day-cream",
  ...
  "peptide-serum": {
    ...
    "ingredients": [
      {
        ...
        "bg": "#FCEAD0",
        "nm": "Hydroxyproline Peptide",
        "ds": "Soutient la fermeté et l'élasticité dans le temps.",
        "pct": "2.5%"
      },
      {
        "abbr": "AL",
        "bg": "#E3EEF5",
        "nm": "Aloe Juice",
        "ds": "Apaise, calme et soutient la barrière cutanée.",
        "pct": "Base"
      },
      {
        "abbr": "HA",
        "bg": "#E6EFE9",
        "nm": "Hyaluronic Acid",
        "ds": "Retient l'eau dans les couches supérieures de la peau.",
        "pct": "1%"
      },
      {
        "abbr": "GIN",
        "bg": "#FAF7C9",
        "nm": "Ginkgo Leaf Extract",
        "ds": "Antioxydant botanique — une défense douce au quotidien.",
        "pct": "0.4%"
      },
      {
        "abbr": "BB",
        "bg": "#FCE8EB",
        "nm": "Blueberry & Strawberry Seed Oil",
        "ds": "Riche en vitamine E — adoucit le fini.",
        "pct": "Trace"
      }
    ],
    ...
    "benefitGrad": "linear-gradient(160deg,#F5C98A,#E0AC58)",
    "quote": "\"Après quatre semaines, ma peau se tient différemment. Moins tendue. Plus la mienne.\"",
    "benefitTitle": "Une fermeté à libération lente, <em>intégrée à un rituel quotidien.</em>",
    "benefitBody": [
      "Les peptides n'agissent pas comme un effet éclat instantané — ils agissent comme le sommeil. Vous ne remarquerez pas le premier jour. Vous remarquerez la troisième semaine.",
      "Conçu pour un rythme long et doux : une essence fine à absorption rapide avec un complexe peptidique stable, une base d'aloès apaisante, et juste assez d'acide hyaluronique pour ressembler à une gorgée d'eau pour une peau fatiguée."
    ],
    "stats": [
      {
        "n": "+23",
        "suf": "%",
        "l": "Regain de fermeté après 4 semaines"
      },
      {
        "n": "94",
        "suf": "%",
        "l": "Peau plus douce et apaisée dès la semaine 1"
      },
      {
        "n": "0",
        "suf": "",
        "l": "Parfum, sulfates, picotements des rétinoïdes"
      }
    ],
    ...
    "inci": "Aqua (Water), Aloe Barbadensis Leaf Juice, Glycerin, Propanediol, Sodium Hyaluronate, Hydroxyproline, Phytosteryl Oleate, Tocopherol, Vaccinium Myrtillus (Blueberry) Seed Oil, Fragaria Ananassa (Strawberry) Seed Oil, Ginkgo Biloba Leaf Extract, Sodium Phytate, Xanthan Gum, Citric Acid, Sodium Benzoate, Potassium Sorbate, Phenoxyethanol.",
    "inciNote": "91,4% d'origine naturelle. 100% végan. Sans parfum, parabènes, ni sulfates.",
    "pairs": [
      "cleansing-foam",
      "hydrating-toner",
      "firming-day-cream",
  ...
  "retinol-alt-serum": {
    ...
    "ingredients": [
      {
        ...
        "bg": "#FCE8EB",
        "nm": "Bakuchiol",
        "ds": "Équivalent végétal du rétinol — renouvelle sans irriter.",
        "pct": "1.5%"
      },
      {
        "abbr": "GLA",
        "bg": "#FAF7C9",
        "nm": "Gluconolactone (PHA)",
        "ds": "Exfoliation douce — exfolie pendant le sommeil.",
        "pct": "3%"
      },
      {
        "abbr": "NIA",
        "bg": "#E3EEF5",
        "nm": "Niacinamide",
        "ds": "Minimise les pores, apaise, renforce la barrière.",
        "pct": "5%"
      },
      {
        "abbr": "SQL",
        "bg": "#E6EFE9",
        "nm": "Squalane",
        "ds": "Hydratation identique aux lipides — s'absorbe en secondes.",
        "pct": "2%"
      },
      {
        "abbr": "PAN",
        "bg": "#E3EEF5",
        "nm": "Panthenol",
        "ds": "Apaise et renforce la barrière pendant la nuit.",
        "pct": "1%"
      }
    ],
    ...
    "benefitBody": [
      ...
      "Le bakuchiol active la même voie de renouvellement, sans l'irritation des rétinoïdes. Vous obtenez le lissage, la réduction des ridules, le renouvellement cellulaire — chaque nuit, dès la première nuit."
    ],
    "stats": [
      {
        "n": "0.5",
        "suf": "%",
        "l": "Efficacité équivalente au rétinol grâce au bakuchiol"
      },
      {
        "n": "96",
        "suf": "%",
        "l": "Aucune irritation ni phase d'adaptation"
      },
      {
        "n": "0",
        "suf": "",
        "l": "Rétinoïdes, parfum, huiles essentielles"
      }
    ],
    "faqTitle": "Questions sur <em>ce sérum.</em>",
    "faqs": [
    ...
    "inci": "Aqua, Glycerin, Bakuchiol (1.5%), Gluconolactone (3%), Niacinamide (5%), Squalane, Panthenol, Tocopherol, Sodium Hyaluronate, Xanthan Gum, Sodium Benzoate, Potassium Sorbate, Citric Acid.",
    "inciNote": "93,1% d'origine naturelle. 100% végan. Sans rétinoïdes, parfum, ni huiles essentielles.",
    "pairs": [
      "cleansing-foam",
      "hydrating-toner",
      "ceramide-night-cream",
  ...
  "firming-day-cream": {
    ...
    "ingredients": [
      {
        ...
        "bg": "#FCE8EB",
        "nm": "Peptide Complex",
        "ds": "Soutient la production de collagène et la fermeté visible.",
        "pct": "2%"
      },
      {
        "abbr": "SHE",
        "bg": "#FAF7C9",
        "nm": "Shea Butter (light fraction)",
        "ds": "Acides gras riches — nourrit sans lourdeur.",
        "pct": "4%"
      },
      {
        "abbr": "NIA",
        "bg": "#E3EEF5",
        "nm": "Niacinamide",
        "ds": "Illumine, resserre les pores, améliore la texture.",
        "pct": "4%"
      },
      {
        "abbr": "SQL",
        "bg": "#E6EFE9",
        "nm": "Squalane",
        "ds": "Émollient identique à la peau — s'absorbe instantanément.",
        "pct": "3%"
      },
      {
        "abbr": "VE",
        "bg": "#E6EFE9",
        "nm": "Tocopherol (Vitamin E)",
        "ds": "Protection antioxydante pour la journée à venir.",
        "pct": "0.5%"
      }
    ],
    ...
    "benefitGrad": "linear-gradient(160deg,#E9B7A8,#CC8E7A)",
    "quote": "\"Ma peau semble se tenir différemment. Moins fatiguée l'après-midi.\"",
    "benefitTitle": "Une hydratation diurne qui <em>ne disparaît pas à midi.</em>",
    "benefitBody": [
      "La plupart des crèmes de jour restent en surface et s'évaporent. Celle-ci utilise un système de superposition occlusif-humectant — elle attire l'eau et la retient.",
      "Le complexe peptidique ajoute un second objectif : un raffermissement progressif et visible au fil des semaines. Un seul produit, deux raisons de l'utiliser chaque matin."
    ],
    "stats": [
      {
        "n": "8",
        "suf": "h",
        "l": "Hydratation durable"
      },
      {
        "n": "+19",
        "suf": "%",
        "l": "Fermeté après 6 semaines"
      },
      {
        "n": "0",
        "suf": "",
        "l": "Silicones lourds, huile minérale, parfum"
      }
    ],
    ...
    "inci": "Aqua, Glycerin, Butyrospermum Parkii (Shea) Butter, Squalane, Niacinamide (4%), Hydroxyproline, Tocopherol, Glyceryl Stearate, Cetyl Alcohol, Sodium Hyaluronate, Xanthan Gum, Phenoxyethanol, Citric Acid.",
    "inciNote": "87,6% d'origine naturelle. 100% végan. Sans parfum, huile minérale, ni silicones lourds.",
    "pairs": [
      "peptide-serum",
      "vitamin-c-serum",
      "spf50-stick",
  ...
  "ceramide-night-cream": {
    ...
    "ingredients": [
      {
        ...
        "bg": "#EFDFC2",
        "nm": "Ceramide NP",
        "ds": "Molécule lipidique qui reconstruit la barrière d'hydratation.",
        "pct": "1%"
      },
      {
        "abbr": "SHE",
        "bg": "#FAF7C9",
        "nm": "Shea Butter",
        "ds": "Profondément nourrissant — adoucit et apaise pendant la nuit.",
        "pct": "6%"
      },
      {
        "abbr": "BAK",
        "bg": "#FCE8EB",
        "nm": "Bakuchiol",
        "ds": "Renouvellement nocturne en douceur pendant la régénération de la peau.",
        "pct": "0.5%"
      },
      {
        "abbr": "HA",
        "bg": "#E3EEF5",
        "nm": "Hyaluronic Acid",
        "ds": "Hydratation profonde pendant le long cycle de sommeil.",
        "pct": "1%"
      },
      {
        "abbr": "PAN",
        "bg": "#E6EFE9",
        "nm": "Panthenol",
        "ds": "Apaise et soutient l'intégrité de la peau pendant la nuit.",
        "pct": "1%"
      }
    ],
    "ingTitle": "Des céramides qui reconstruisent. <em>Pendant la nuit.</em>",
    "howTitle": "La dernière étape. <em>Chaque soir.</em>",
    "howÉtapes": [
      {
    ...
    "benefitGrad": "linear-gradient(160deg,#EFDFC2,#D4C09A)",
    "quote": "\"Je me réveille avec une peau différente maintenant. Moins tendue, plus comme si elle m'appartenait à nouveau.\"",
    "benefitTitle": "Le sommeil est le moment où la peau <em>fait son meilleur travail.</em>",
    "benefitBody": [
      "Les céramides sont les lipides qui maintiennent vos cellules cutanées ensemble — elles représentent environ 50% de la barrière cutanée. L'âge, la météo et les actifs les épuisent lentement.",
      "Cette crème les reconstitue pendant la nuit, quand la barrière est en mode de réparation active. Le résultat : moins de tiraillement le matin, moins de sensibilité pendant la journée."
    ],
    "stats": [
      {
        "n": "2",
        "suf": "w",
        "l": "Barrière restaurée, mesure clinique"
      },
      {
        "n": "91",
        "suf": "%",
        "l": "Peau plus douce en 7 matins"
      },
      {
        "n": "0",
        "suf": "",
        "l": "Parfum, huile minérale, parabènes"
      }
    ],
    ...
    "inci": "Aqua, Glycerin, Butyrospermum Parkii (Shea) Butter, Ceramide NP (1%), Squalane, Panthenol, Niacinamide, Bakuchiol (0.5%), Tocopherol, Sodium Hyaluronate, Glyceryl Stearate, Cetyl Alcohol, Phenoxyethanol, Citric Acid.",
    "inciNote": "88,4% d'origine naturelle. 100% végan. Sans parfum, huile minérale, ni parabènes.",
    "pairs": [
      "retinol-alt-serum",
      "peptide-serum",
      "cleansing-foam",
  ...
  "smoothing-eye-cream": {
    ...
    "quickInfo": [
      [
        "Zone oculaire délicate",
        "Sans parfum, sans huiles essentielles"
      ],
      [
        "Matin et soir",
        "Tapotez doucement — ne jamais frotter"
      ]
    ],
    "routineActive": -1,
    "ingredients": [
      {
        ...
        "bg": "#E6EFE9",
        "nm": "Caffeine",
        "ds": "Réduit visiblement les poches et les cernes.",
        "pct": "2%"
      },
      {
        "abbr": "PEP",
        "bg": "#C9D7C9",
        "nm": "Peptide Complex",
        "ds": "Soutient l'élasticité de la peau fine du contour de l'œil.",
        "pct": "1.5%"
      },
      {
        "abbr": "HA",
        "bg": "#E3EEF5",
        "nm": "Hyaluronic Acid",
        "ds": "Repulpe les ridules de l'intérieur.",
        "pct": "1%"
      },
      {
        "abbr": "CUC",
        "bg": "#E6EFE9",
        "nm": "Cucumber Fruit Extract",
        "ds": "Rafraîchit instantanément et réduit les poches.",
        "pct": "2%"
      },
      {
        "abbr": "NIA",
        "bg": "#E3EEF5",
        "nm": "Niacinamide",
        "ds": "Illumine les décolorations sous les yeux avec le temps.",
        "pct": "3%"
      }
    ],
    "ingTitle": "Des actifs ciblés pour <em>une peau délicate.</em>",
    "howTitle": "Annulaire. <em>Tapotez, ne frottez pas.</em>",
    "howÉtapes": [
      {
    ...
    "benefitGrad": "linear-gradient(160deg,#B3C9B3,#8CAD8C)",
    "quote": "\"On a arrêté de me demander si j'étais fatiguée. C'est tout ce dont j'avais besoin.\"",
    "benefitTitle": "Le contour de l'œil est différent. <em>Il a besoin de différent.</em>",
    "benefitBody": [
      "La peau autour de l'œil est 40% plus fine que le reste du visage. Elle n'a pas de glandes sébacées, pas de graisse sous-cutanée, et subit des milliers de micro-mouvements par jour.",
      "Les hydratants standards sont trop lourds, les sérums standards peuvent piquer. Cette crème est formulée spécifiquement pour cette zone — avec de la caféine pour réduire les poches, des peptides pour raffermir, et de l'acide hyaluronique au bon poids moléculaire pour atteindre là où c'est nécessaire."
    ],
    "stats": [
      {
        "n": "-34",
        "suf": "%",
        "l": "Réduction des poches en 4 semaines"
      },
      {
        "n": "88",
        "suf": "%",
        "l": "Contour des yeux plus lumineux à 6 semaines"
      },
      {
        "n": "0",
        "suf": "",
        "l": "Parfum, huiles essentielles, picotements"
      }
    ],
    "faqTitle": "Questions sur <em>la crème contour des yeux.</em>",
    "faqs": [
      {
    ...
    "inci": "Aqua, Glycerin, Caffeine (2%), Sodium Hyaluronate, Hydroxyproline, Niacinamide (3%), Cucumis Sativus (Cucumber) Fruit Extract, Tocopherol, Panthenol, Xanthan Gum, Sodium Benzoate, Potassium Sorbate, Citric Acid.",
    "inciNote": "90,2% d'origine naturelle. 100% végan. Sans parfum, parabènes, ni huiles essentielles.",
    "pairs": [
      "peptide-serum",
      "firming-day-cream",
      "ceramide-night-cream",
  ...
  "spf50-stick": {
    ...
    "ingredients": [
      {
        ...
        "bg": "#E8D5B0",
        "nm": "Zinc Oxide",
        "ds": "Filtre UV minéral à large spectre — sûr et stable.",
        "pct": "20%"
      },
      {
        "abbr": "TiO",
        "bg": "#FAF7C9",
        "nm": "Titanium Dioxide",
        "ds": "Filtre UV complémentaire — ajoute une protection UVB.",
        "pct": "5%"
      },
      {
        "abbr": "SHE",
        "bg": "#E6EFE9",
        "nm": "Shea Butter",
        "ds": "Base lissante, conditionnante pour la peau.",
        "pct": "8%"
      },
      {
        "abbr": "JOJ",
        "bg": "#E3EEF5",
        "nm": "Jojoba Seed Oil",
        "ds": "Émollient léger — sans résidu.",
        "pct": "3%"
      },
      {
        "abbr": "VE",
        "bg": "#FCE8EB",
        "nm": "Tocopherol (Vitamin E)",
        "ds": "Soutien antioxydant en complément de la défense UV.",
        "pct": "0.5%"
      }
    ],
    "ingTitle": "Filtres minéraux. <em>Rien d'autre à craindre.</em>",
    "howTitle": "Dernière étape. <em>Chaque matin.</em>",
    "howÉtapes": [
      {
      ...
      },
      {
        ...
        "p": "Passez directement sur le front, chaque joue, le nez, le menton. Puis fondez légèrement avec les doigts."
      },
      {
    ...
    "benefitGrad": "linear-gradient(160deg,#E8D5B0,#C8A870)",
    "quote": "\"J'ai arrêté de sauter le SPF parce que j'ai arrêté de détester la sensation.\"",
    "benefitTitle": "L'étape qui protège <em>tout ce que vous faites d'autre.</em>",
    "benefitBody": [
      "Les UV sont responsables d'environ 80% du vieillissement cutané visible. Chaque sérum, chaque crème, chaque rituel que vous faites — le SPF protège cet investissement.",
      "Le format stick existe pour une raison : la réapplication est l'étape que tout le monde saute. Sortez-le, passez-le, terminé. Pas besoin de défaire son maquillage, pas de pompe à renverser, pas d'excuse."
    ],
    "stats": [
      {
        "n": "50",
        "suf": "+",
        "l": "Indice SPF, PA++++ large spectre"
      },
      {
        "n": "94",
        "suf": "%",
        "l": "Pas de traces blanches (peau claire à moyenne)"
      },
      {
        "n": "0",
        "suf": "",
